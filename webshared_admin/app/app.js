angular.module("app", ['ngRoute', 'ngCookies', 'ngSanitize', "activity", 'system', 'dialogs', 'framework.controllers', 'zy.services', 'zy.directives', 'zy.filters', 'zy.untils', 'ngProgress', 'ngStorage', 'ngDialog', 'angularFileUpload', 'ui.utils', 'ui.bootstrap', 'ui.bootstrap.datetimepicker','dateRange'])
    .config([
