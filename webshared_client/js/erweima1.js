...
$(function(){
    $.ajax({
        ...
        success:function(data){
            $(".erweima").append('<img src='+data.qrcodeurl+' width="38%" style="box-shadow:10px -10px 20px #777"/>');
            $(".down").css("background","url(http://gobiiig.com:8003"+data.images.poster[1]+") no-repeat");
        }
    });
})
function load(){
